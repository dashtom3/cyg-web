			...
			<div class="personal-content-left">
				<div class="personal-left-top">
					...
					<div class="cont-left-personright">
						<span class="personright-left-words">INFORMATION</span>
						<span class="personright-right-words">个 <br/>人<br/>信<br/>息</span>
					</div>
				</div>
